    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <style type="text/css">.sidebar .treeview-menu .sidebar-menu .dropdown .dropdown-menu{background: #2c3b41}.sidebar .treeview-menu .sidebar-menu .dropdown a:hover{background: #2c3b41;color: #fff;cursor: pointer}</style> 
        </section>
